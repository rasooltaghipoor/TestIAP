...
namespace UnityEditor.Purchasing
{
    ...
    /// </summary>
	[CustomEditor(typeof(RtlIapButton))]
	...
	public class IAPButtonEditor : Editor
	{
		...
		private static readonly string[] restoreButtonExcludedFields = new string[] { "m_Script", "consumePurchase", "onPurchaseComplete", "onPurchaseFailed", "titleText", "descriptionText", "priceText", "titleRTLText", "descriptionRTLText", "priceRTLText" };
		...
		{
			RtlIapButton button = (RtlIapButton)target;
